            ...
            <div className="flex items-center justify-center min-h-screen p-4">
                ...
                <div className="relative bg-amber-600 rounded-lg max-h-90 shadow-card p-6 z-20">
                    ...
                    {path.points.length > 10 ?
                        <h1 className="text-white text-xl">A rota aprox. mais rápida da firma entre <br /> os pontos voltando para o início</h1>
                        :
                        <h1 className="text-white text-xl">A rota mais rápida da firma entre <br /> os pontos voltando para o início</h1>
                    }
